...
export interface ApiOdderOdder extends Schema.CollectionType {
  collectionName: 'odders';
  info: {
    singularName: 'odder';
    pluralName: 'odders';
    displayName: 'odder';
  ...
  attributes: {
    ...
    odderId: Attribute.UID & Attribute.Required;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.Enumeration<['tshirt', 'mug', 'hoodie', 'sticker']> &
      Attribute.Required &
    ...
    available: Attribute.Integer & Attribute.Required & Attribute.DefaultTo<0>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
